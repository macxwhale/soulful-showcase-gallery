    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        ...
        <p className="text-xl md:text-2xl text-slate-300 mb-12 max-w-3xl mx-auto leading-relaxed animate-fade-in delay-500">
          I create beautiful, functional web applications that users love. From concept to deployment, 
          I bring ideas to life with modern technology and thoughtful design.
        </p>
